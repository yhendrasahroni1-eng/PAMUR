...
export const initialAppSettings: AppSettings = {
  ...
  emailAdmin: 'admin@pamur-indonesia.org',
...
export const initialUsers: User[] = [
  {
    ...
    nama: 'Master Bambang Suroso, M.Pd.',
    email: 'admin@pamur.org',
    password: 'admin',
    role: 'admin',
    tingkatSabuk: 'Hitam',
    ...
    tanggalBergabung: '2005-01-10',
    statusAktif: true,
    terverifikasi: true,
    presensiCount: 142,
    catatanPrestasi: [
      'Dewan Pelatih Nasional PAMUR 2020-2026',
      'Wasit Juri IPSI Tingkat Nasional',
      'Juara 1 Pendekar Senjata Ganda Kejurnas 2012'
    ]
  },
  {
    id: 'usr-siswa-1',
    nis: 'PMR-2024-088',
    nik: '3528011708040002',
    nama: 'Ahmad Faiz Zulkarnain',
    email: 'faiz.pamur@gmail.com',
    password: 'siswa',
    role: 'siswa',
    tingkatSabuk: 'Biru',
    ranting: 'Ranting Pamekasan Pusat',
    tempatLahir: 'Pamekasan',
    tanggalLahir: '2004-08-17',
    jenisKelamin: 'Laki-Laki',
    noWa: '6285712345678',
    alamat: 'Jl. Kabupaten No. 88, Pamekasan',
    fotoUrl: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&q=80&w=400',
    tanggalBergabung: '2023-03-15',
    statusAktif: true,
    terverifikasi: true,
    presensiCount: 38,
    catatanPrestasi: [
      'Juara 2 Tanding Kelas D Putra O2SN Kabupaten Pamekasan 2024',
      'Peserta Terbaik Latihan Gabungan Se-Madura 2025'
    ]
  },
  {
    id: 'usr-siswa-2',
    nis: 'PMR-2024-102',
    nik: '3578022011050003',
    nama: 'Siti Nurhaliza Arifin',
    ...
    noWa: '6281987654321',
    alamat: 'Jl. Dharmawangsa No. 42, Surabaya',
    ...
    presensiCount: 22,
    catatanPrestasi: [
      'Juara 3 Seni Tunggal Putri Kejurprov Jatim 2025'
    ]
  },
  {
    id: 'usr-siswa-3',
    nis: 'PMR-2025-015',
    nik: '3573010503060004',
    nama: 'Rehan Maulana Ibrahim',
    email: 'rehan.ibrahim@gmail.com',
    password: 'siswa',
    role: 'siswa',
    tingkatSabuk: 'Putih',
    ranting: 'Ranting Malang Kota',
    tempatLahir: 'Malang',
    tanggalLahir: '2006-03-05',
    jenisKelamin: 'Laki-Laki',
    noWa: '6281357924680',
    alamat: 'Jl. Soekarno Hatta No. 19, Malang',
    ...
    statusAktif: true,
    terverifikasi: false, // Pending verification
    presensiCount: 4,
    catatanPrestasi: []
  }
];
